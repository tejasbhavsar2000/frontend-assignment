...
const RepositoriesSection = () => {
  return (
    <div className="md:flex-1 border-[#E9EAEB] border md:m-5 md:rounded-xl md:bg-white ">
      <div className="flex p-4 flex-col md:flex-row gap-4 justify-between md:p-8">
      ...
      <div className="flex px-4 pb-4 md:w-1/3 md:px-8">
        <SearchBar />
      </div>
