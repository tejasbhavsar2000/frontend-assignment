...
const RepositoryCard = ({ title, type, lang, size, updatedAt }) => {
  return (
    <div className="border-t cursor-pointer md:hover:bg-[#ecedf0] p-4 font-[Inter] border-t-[#D5D7DA] w-full flex flex-col gap-4 md:px-8">
      ...
      <div className="flex items-center gap-6 text-[0.875rem] leading-5 text-nowrap">
        ...
        <div className="flex items-center gap-2">{updatedAt}</div>
      </div>
    </div>
  );
};
